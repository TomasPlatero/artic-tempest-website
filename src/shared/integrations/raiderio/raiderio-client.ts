...
export async function fetchCharacterRIO(
	...
	const raidField =
		"raid_progression:sporefall:tier-mn-1:manaforge-omega:liberation-of-undermine:nerubar-palace:amirdrassil-the-dreams-hope:aberrus-the-shadowed-crucible:vault-of-the-incarnates:sepulcher-of-the-first-ones:sanctum-of-domination:castle-nathria";
