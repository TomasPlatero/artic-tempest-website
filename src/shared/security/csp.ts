...
/**
 * Content Security Policy — shared between next.config.ts headers and middleware.
 * Production-only values; dev additions (unsafe-eval, toolbar) are injected at call sites.
 */
