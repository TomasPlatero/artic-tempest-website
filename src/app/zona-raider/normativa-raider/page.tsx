...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://artictempest.es/zona-raider/normativa-raider' },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    type: "website",
...
async function renderRaiderNormsPage() {
  ...
  return (
    <div className={`space-y-6 pb-6 ${RAIDER_PAGE_FADE_IN_CLASSES}`}>
      <section className={`relative overflow-hidden rounded-[2rem] border border-white/10 bg-linear-to-br from-blue-500/10 via-white/[0.03] to-transparent p-6 md:p-8 shadow-2xl shadow-black/20 ${RAIDER_CARD_REVEAL_CLASSES}`}>
        ...
        <div className="relative space-y-5">
          ...
          <div className={`grid gap-3 md:grid-cols-4 ${RAIDER_STAGGER_DELAY_CLASSES[1]}`}>
            {[
      ...
      <div className="space-y-6">
        <Card className={`border-white/10 bg-white/[0.03] ${RAIDER_CARD_REVEAL_CLASSES} ${RAIDER_STAGGER_DELAY_CLASSES[2]}`}>
