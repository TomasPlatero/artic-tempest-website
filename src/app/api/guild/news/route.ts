...
export async function GET(req: Request) {
    try {
        ...
        const isStaff = session && (session.user.roleLevel === 'gm' || session.user.roleLevel === 'officer')
...
export async function POST(req: Request) {
    ...
    try {
        ...
        const { title, slug, summary, content, category, author, is_featured, image_url, status } = body
