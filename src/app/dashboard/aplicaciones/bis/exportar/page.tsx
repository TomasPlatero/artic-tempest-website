  ...
  return (
    <div className="flex flex-col gap-6 p-4 md:p-6 lg:px-8 w-full max-w-full">
      <div className="flex items-center gap-6">
        <Link href="/dashboard/aplicaciones/bis">
          <Button
            variant="outline"
            size="icon"
        ...
        <div>
          ...
          <p className="text-sm font-medium text-white/40 mt-2 uppercase tracking-widest">
            Copia los datos de BiS para importarlos en
            RCLootCouncil_ArticTempest.
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-white/5 border-white/10">
            <CardHeader>
              <CardTitle className="text-sm font-semibold uppercase tracking-wider text-emerald-500">
                Paso 1
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground text-sm">
                Haz clic en el botón inferior para copiar el código JSON
          ...
          <Card className="bg-white/5 border-white/10">
            <CardHeader>
              <CardTitle className="text-sm font-semibold uppercase tracking-wider text-blue-500">
                Paso 2
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground text-sm">
                Abre World of Warcraft y accede a la configuración de{" "}
                <strong>RCLootCouncil_ArticTempest</strong>.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/5 border-white/10">
            <CardHeader>
              <CardTitle className="text-sm font-semibold uppercase tracking-wider text-purple-500">
                Paso 3
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground text-sm">
                Pega el código en la sección de &quot;Importar BiS&quot; y
        ...
        <Card className="bg-white/5 border-white/10">
          <CardHeader>
            ...
            <CardDescription>
              El JSON de exportacion se mantiene estable para el import de{" "}
              <strong>RCLootCouncil_ArticTempest</strong>.
            </CardDescription>
          </CardHeader>
          <CardContent className="text-sm text-muted-foreground space-y-2">
            <p>
              <strong className="text-white">schemaVersion</strong>: `1`
            </p>
            <p>
              <strong className="text-white">timestamp</strong>: unix timestamp
              entero
            </p>
            <p>
              <strong className="text-white">data</strong>: objeto con clave
              `Nombre-Reino`
            </p>
            <p>
              <strong className="text-white">items</strong>: clave `itemId +
              M/H/N/L`
            </p>
            <p>
              <strong className="text-white">campos</strong>: `isBis`, `ilvl?`,
              `bonusIds?`, `priority?`
            </p>
          </CardContent>
        </Card>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem
            value="export-code"
            className="border-emerald-500/20 bg-emerald-500/5 rounded-xl px-6 border"
          >
            <AccordionTrigger className="hover:no-underline py-6">
              <div className="flex items-center gap-3 text-left">
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-500/60 font-normal">
                    Clic para desplegar el formato JSON para el addon.
                  </p>
                </div>
              </div>
            </AccordionTrigger>
