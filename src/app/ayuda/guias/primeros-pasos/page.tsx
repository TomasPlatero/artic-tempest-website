...
import { IconUser, IconLink, IconCheck } from "@/shared/ui/tabler-icons"
            ...
            <div className="space-y-12">
                <section className="space-y-6">
                    ...
                    <p className="text-white/60 leading-relaxed">
                        Artic Tempest utiliza Discord como sistema principal de identificación. Para acceder a la web, debes estar en el servidor oficial de Artic Tempest.
                    </p>
                    <ul className="space-y-4">
                        {[
                            "Inicia sesión en la web pulsando el botón superior derecho.",
                            "Autoriza la aplicación de Artic Tempest en tu cuenta de Discord.",
                            "Asegúrate de tener el rango de 'Miembro' en el servidor para ver todo el contenido."
                        ].map((step) => (
                            <li key={step} className="flex items-start gap-3 text-white/50">
                ...
                <section className="space-y-6">
                    <h2 className="text-2xl font-semibold text-white uppercase tracking-tight">Vincular Battle.net</h2>
                    <p className="text-white/60 leading-relaxed">
                    ...
                    <div className="p-8 rounded-[2rem] bg-white/[0.02] border border-white/5 space-y-4">
                        <p className="text-white/50 text-sm font-medium">
                            Ve a tu <Link href="/zona-raider/cuenta" className="text-blue-400 hover:underline">Perfil de Usuario</Link> y busca la sección de Conexiones. Pulsa en el botón azul de Battle.net y sigue los pasos en la web de Blizzard.
                        </p>
                    </div>
                </section>

                <section className="p-8 rounded-[2rem] bg-amber-500/5 border border-amber-500/10">
                    <h4 className="text-amber-400 font-semibold uppercase text-xs tracking-widest mb-2 italic">⚠️ Importante</h4>
