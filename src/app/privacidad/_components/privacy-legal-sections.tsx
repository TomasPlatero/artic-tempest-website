	...
	return (
		...
		>
			<p className="text-zinc-300 leading-relaxed text-sm">
				...
				seguridad de los datos personales, de acuerdo con el artículo 32 del RGPD.
				Entre ellas se incluyen:
			</p>
			<ul className="text-zinc-300 space-y-2 text-sm list-disc list-inside">
				<li>Cifrado en tránsito mediante TLS 1.3 en todas las comunicaciones.</li>
				...
				<li>
					Acceso restringido a datos personales exclusivamente a administradores y
					officers de la hermandad, mediante control de roles en la base de datos.
				</li>
				<li>
				...
				<li>
					Protección anti-bots mediante Cloudflare Turnstile en formularios públicos,
					verificando solicitudes sin recopilar datos personales adicionales.
				</li>
				<li>
					Monitorización continua de la infraestructura y actualización periódica de
					dependencias.
				</li>
			</ul>
			<p className="text-zinc-300 leading-relaxed text-sm">
				En caso de violación de la seguridad de los datos personales, notificaremos
				a la Agencia Española de Protección de Datos (AEPD) en un plazo máximo de 72
				horas, así como a los interesados cuando sea probable que dicha violación
...
export function RightsSection() {
	return (
		...
		>
			<p className="text-zinc-300 leading-relaxed text-sm">
				De acuerdo con los artículos 15 a 22 del RGPD y los artículos 11 a 18 de la
				LOPD-GDD, puedes ejercer los siguientes derechos:
			</p>
			...
			<div className="mt-8 pt-8 border-t border-blue-500/20 space-y-3">
				<p className="text-sm text-blue-100/90 font-semibold leading-relaxed">
					...
					<strong className="text-white">admin@artictempest.es</strong> indicando el
					derecho que deseas ejercer y adjuntando una copia de tu documento de
					identidad. Responderemos en el plazo máximo de un mes, ampliable a dos
		...
		>
			<div className="space-y-6">
				<p className="text-zinc-300 text-sm leading-relaxed">
					Utilizamos cookies técnicas necesarias para el funcionamiento del sitio y,
					con tu consentimiento, cookies analíticas (Google Analytics 4) y
					publicitarias (Google AdSense) cuando estos servicios están activos en la
					configuración del sitio. La cookie <code>cookieyes-consent</code> de
					CookieYes y <code>cf_clearance</code> de Cloudflare Turnstile son
					estrictamente necesarias y no requieren consentimiento. La base legal para
					las cookies necesarias es el interés legítimo (art. 6.1.f RGPD); para las
					analíticas y publicitarias, tu consentimiento explícito (art. 6.1.a RGPD),
					gestionado a través de CookieYes.
				</p>
				<p className="text-zinc-300 text-sm leading-relaxed">
					Puedes modificar o retirar tu consentimiento en cualquier momento desde el
					enlace de configuración de cookies que aparece en el banner de
					consentimiento. Para información detallada sobre cada cookie, su duración y
					finalidad, consulta nuestra{" "}
					<Link
						href="/cookies"
...
export function AdsSection() {
	return (
		<PrivacidadSection
			...
			icon={
				<IconAlertTriangle className="text-amber-400 size-6" aria-hidden="true" />
			}
		>
			<div className="space-y-4">
				<p className="text-zinc-300 text-sm leading-relaxed">
					Cuando la monetización está activa en la configuración del sitio, Google
					AdSense puede mostrar anuncios en las páginas públicas. Este servicio
					utiliza cookies para medición y atribución publicitaria. La personalización
					de anuncios requiere tu consentimiento explícito, gestionado a través del
					banner de cookies.
				</p>
				...
				<p className="text-xs text-zinc-400 leading-relaxed">
					Google LLC puede acceder a datos derivados de la entrega de anuncios y su
					medición. Consulta la{" "}
					<a
