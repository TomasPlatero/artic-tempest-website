...
> = {
  ...
  12786: { track: 'Campeon', current: 2, max: 6, ilvl: 250 },
  12787: { track: 'Campeon', current: 3, max: 6, ilvl: 253 },
  12788: { track: 'Campeon', current: 4, max: 6, ilvl: 256 },
  12789: { track: 'Campeon', current: 5, max: 6, ilvl: 259 },
  12790: { track: 'Campeon', current: 6, max: 6, ilvl: 263 },
  12793: { track: 'Heroico', current: 1, max: 6, ilvl: 259 },
  12794: { track: 'Heroico', current: 2, max: 6, ilvl: 263 },
  12795: { track: 'Heroico', current: 3, max: 6, ilvl: 266 },
  12796: { track: 'Heroico', current: 4, max: 6, ilvl: 269 },
  12797: { track: 'Heroico', current: 5, max: 6, ilvl: 272 },
  12798: { track: 'Heroico', current: 6, max: 6, ilvl: 276 },
  12801: { track: 'Mitico', current: 1, max: 6, ilvl: 272 },
  12802: { track: 'Mitico', current: 2, max: 6, ilvl: 276 },
  12803: { track: 'Mitico', current: 3, max: 6, ilvl: 279 },
  12804: { track: 'Mitico', current: 4, max: 6, ilvl: 282 },
  12805: { track: 'Mitico', current: 5, max: 6, ilvl: 285 },
  12806: { track: 'Mitico', current: 6, max: 6, ilvl: 289 },
};
...
> = {
  normal: {
    ...
    steps: [
      ...
      { current: 2, ilvl: 250, bonusId: 12786 },
      { current: 3, ilvl: 253, bonusId: 12787 },
      { current: 4, ilvl: 256, bonusId: 12788 },
      { current: 5, ilvl: 259, bonusId: 12789 },
      { current: 6, ilvl: 263, bonusId: 12790 },
    ],
  },
  heroic: {
    track: 'Heroico',
    steps: [
      ...
      { current: 2, ilvl: 263, bonusId: 12794 },
      { current: 3, ilvl: 266, bonusId: 12795 },
      { current: 4, ilvl: 269, bonusId: 12796 },
      { current: 5, ilvl: 272, bonusId: 12797 },
      { current: 6, ilvl: 276, bonusId: 12798 },
    ],
  },
  mythic: {
    track: 'Mitico',
    steps: [
      ...
      { current: 2, ilvl: 276, bonusId: 12802 },
      { current: 3, ilvl: 279, bonusId: 12803 },
      { current: 4, ilvl: 282, bonusId: 12804 },
      { current: 5, ilvl: 285, bonusId: 12805 },
      { current: 6, ilvl: 289, bonusId: 12806 },
    ],
  },
};
