...
export function SettingsMenuClient() {
  ...
  return (
    <div className="flex flex-col gap-8 w-full max-w-full animate-in fade-in duration-500">
      <AdminPageHeader
        title="AJUSTES DE MENU"
        description="Gestiona la estructura jerárquica y el acceso de los enlaces laterales."
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button className="w-full sm:w-auto gap-2 px-8 h-12 font-black uppercase text-xs tracking-widest shadow-xl shadow-primary/10">
                ...
                <IconChevronDownTabler className="size-3 opacity-50" />
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent
              align="end"
              className="bg-zinc-950 border-white/10 min-w-[200px] rounded-xl shadow-2xl"
            >
              <DropdownMenuItem
              ...
              >
                <IconFolderPlus className="size-4 text-primary group-focus:text-inherit" />{" "}
                Nueva Categoría
              </DropdownMenuItem>
              <DropdownMenuItem
                ...
                className="gap-3 py-4 font-black uppercase text-[10px] tracking-widest cursor-pointer focus:bg-primary focus:text-zinc-950"
              >
                <IconLinkPlus className="size-4 text-emerald-500 group-focus:text-inherit" />{" "}
                Nuevo Enlace
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
