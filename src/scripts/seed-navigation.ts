const navigationData = {
    general: [
        { title: "Inicio", url: "/dashboard", icon_name: "IconDashboard", order_index: 0 },
        { title: "Notificaciones", url: "/dashboard/notificaciones", icon_name: "IconBell", badge_key: "notifications", order_index: 1 },
        { title: "Volver a la web", url: "/", icon_name: "IconWorld", order_index: 2 },
    ],
    raider: [
        { title: "Roster", url: "/dashboard/roster", icon_name: "IconUsers", app_id: "roster", order_index: 10 },
        { title: "Calendario", url: "/dashboard/calendario", icon_name: "IconCalendarEvent", app_id: "calendar", order_index: 11 },
        { title: "Lista de Deseos", url: "/dashboard/bis", icon_name: "IconListCheck", app_id: "bis", order_index: 12 },
        { title: "Planificador", url: "/dashboard/planificador-cds", icon_name: "IconTimeline", app_id: "planificador-cds", order_index: 13 },
